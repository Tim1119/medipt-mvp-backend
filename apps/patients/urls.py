...
from .views import PatientRegistrationDetailsView,PatientDiagnosisListView,PatientDiagnosisHistoryView,PatientDiagnosisViewSet
from rest_framework.routers import DefaultRouter



router = DefaultRouter()
router.register('patient-diagnoses-with-vital-sign',PatientDiagnosisViewSet,basename='patient-diagnoses-with-vital-sign')
