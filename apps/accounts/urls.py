...
from .views import ChangePasswordView, LoginAccountView, LogoutView, OrganizationSignupView, PasswordResetConfirmView, PasswordResetRequestView, ResendActivationLinkView, VerifyAccount
